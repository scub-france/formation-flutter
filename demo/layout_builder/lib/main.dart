...
class MyStatelessWidget extends StatelessWidget {
  ...
  build(context) =>
    Scaffold(
      ...
      body: LayoutBuilder(
        // La fonction de rappel (builder) prend en entrée un contexte de construction (BuildContext) et un objet BoxConstraints qui représente les limites de taille maximale et minimale que le widget peut avoir
