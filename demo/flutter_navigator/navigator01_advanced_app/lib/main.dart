...
/// Widget page de type StatefulWidget
/// pour montrer un changement d'état après fermeture de la seconde fenêtre
          ...
          children: [
            ...
            Center(
                child: _resultPopPage == 0
                    ...
                    : Column(
                        children: [
                          const Text("La seconde fenêtre a été fermée avec : "),
                          const SizedBox(height: 10),
                          _resultPopPage == ReturnedArguments.top
                              ? const Text("le bouton flèche en HAUT",
                                  style: TextStyle(fontWeight: FontWeight.bold))
                              : const Text("le bouton en BAS",
                                  style:
...
Route _createRoute() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => SecondPage(
        args: const CalledArguments(
            "Titre de ma deuxième page", "Message de ma deuxième page")),
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            // Séparateur
            const Text("Pour revenir à la première page, cliquez sur : "),
            const SizedBox(height: 10),
            const Text("le bouton ci-dessus"),
            const Text("ou"),
            const Text("l'icône flèche, en haut à gauche."),
          ],
        ),
      ),
    );
